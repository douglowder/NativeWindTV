...
const App: () => React.JSX.Element = () => {
  ...
  const buttonStyleAndroid = `relative m-1.5 bg-blue-500 w-[800px] h-[125px] text-white p-6 font-bold overflow-hidden transition duration-200 hover:bg-blue-300 focus:bg-blue-300 active:bg-green-600`;
  const buttonStyleTVOS = `relative m-3 bg-blue-500 w-[1600px] h-[250px] text-white p-12 font-bold overflow-hidden transition duration-200 hover:bg-blue-300 focus:bg-blue-300 active:bg-green-600`;
  const buttonStyle =
