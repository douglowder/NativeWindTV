...
const App: () => React.JSX.Element = () => {
  ...
  const buttonStyleTVOS = `relative m-3 bg-blue-500 w-[1600px] h-[250px] text-white p-12 font-bold overflow-hidden focus:animate-pulse focus:bg-blue-300 active:bg-green-600`;
  const buttonStyle =
